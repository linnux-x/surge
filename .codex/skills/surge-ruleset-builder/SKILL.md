...
12. Keep deprecated workflows inert. If a legacy workflow is retained for reference, give it a unique `name:`, remove `schedule`, and document that it must not regenerate stale rule inventories.
